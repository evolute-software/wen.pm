...
milestones =
    ...
    , ME.Milestone <| ME.TheMilestone "Alonzo Pioneers Testnet" (Just 1619819091) False Nothing <| Just "The first public testnet for Goguen. The first batch of around 1k external Alonzo pioneers will get access to the Pioneers Testnet where the functionalities of Alonzo will be tested in close collaboration with IOHK."
